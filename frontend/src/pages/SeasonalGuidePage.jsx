  ...
  jaro: {
    ...
    items: [
      ...
      { name:'Chřest', emoji:'🌿', best:'Duben–Červen', tip:'Česká sezóna trvá jen 6–8 týdnů. Nejlepší je bílý chřest z jižní Moravy.',
        img:'https://images.unsplash.com/photo-1515586000433-45406d8e6662?w=400&q=80&fit=crop&auto=format' },
      ...
      { name:'Ředkvičky', emoji:'🔴', best:'Duben–Červen', tip:'Jedny z prvních jarních plodin. Vydrží až do léta.',
        img:'https://images.unsplash.com/photo-1597362925123-77861d3fbac7?w=400&q=80&fit=crop&auto=format' },
      { name:'Pažitka', emoji:'🌿', best:'Březen–Říjen', tip:'Začíná růst jako jedna z prvních – signál, že jaro je tady.',
        img:'https://images.unsplash.com/photo-1618512496248-a07fe83aa8cb?w=400&q=80&fit=crop&auto=format' },
      ...
      { name:'Česnek medvědí', emoji:'🧄', best:'Duben–Květen', tip:'Vzácná lesní bylina s intenzivní vůní. Skvělá čerstvá i jako pesto.',
        img:'https://images.unsplash.com/photo-1628689469838-524a4a973b8e?w=400&q=80&fit=crop&auto=format' },
      { name:'Rebarbora', emoji:'🌸', best:'Květen–Červen', tip:'Kyselá rebarbora je skvělá na koláče, džemy i kompoty. Sezóna je krátká!',
        img:'https://images.unsplash.com/photo-1590165482129-1b8b27698780?w=400&q=80&fit=crop&auto=format' },
    ],
  },
  leto: {
    ...
    items: [
      ...
      { name:'Maliny', emoji:'🍓', best:'Červen–Červenec', tip:'Červencové maliny jsou ideální na džemy a mražené dezerty.',
        img:'https://images.unsplash.com/photo-1498557850523-fd3d118b962e?w=400&q=80&fit=crop&auto=format' },
      { name:'Cukety', emoji:'🥒', best:'Červenec–Září', tip:'Letní přebytek cuket – farmáři je prodávají za hubičku. Na grilování.',
        img:'https://images.unsplash.com/photo-1563565375-f3fdfdbefa83?w=400&q=80&fit=crop&auto=format' },
      { name:'Broskve', emoji:'🍑', best:'Červenec–Srpen', tip:'České broskve z jižní Moravy jsou šťavnaté a plné vůně. Nekupte nikde jinde.',
        img:'https://images.unsplash.com/photo-1595743825637-cdafc8ad4173?w=400&q=80&fit=crop&auto=format' },
      { name:'Kukuřice', emoji:'🌽', best:'Srpen–Září', tip:'Čerstvá sladká kukuřice přímo od farmáře – vařená nebo grilovaná, to je zážitek.',
        img:'https://images.unsplash.com/photo-1551754655-cd27e38d2076?w=400&q=80&fit=crop&auto=format' },
    ],
  },
  podzim: {
    ...
    items: [
      { name:'Dýně', emoji:'🎃', best:'Září–Listopadu', tip:'Česká dýně Hokkaido je nejlepší na polévku. Prodává se od září.',
        img:'https://images.unsplash.com/photo-1570586437263-ab629fccc818?w=400&q=80&fit=crop&auto=format' },
      ...
      { name:'Houby', emoji:'🍄', best:'Září–Října', tip:'Na farmářských trzích najdeš čerstvé i sušené houby z českých lesů.',
        img:'https://images.unsplash.com/photo-1504674900247-0877df9cc836?w=400&q=80&fit=crop&auto=format' },
      ...
      { name:'Řepa', emoji:'🟣', best:'Září–Října', tip:'Červená řepa plná antioxidantů. Skvělá pečená, vařená i jako šťáva.',
        img:'https://images.unsplash.com/photo-1593105544559-ecb03bf76f82?w=400&q=80&fit=crop&auto=format' },
    ],
  },
  zima: {
    ...
    items: [
      ...
      { name:'Jablečný mošt', emoji:'🥤', best:'Říjen–Prosinec', tip:'Lisovaný přímo z jablek. Hledej u sadařů nebo na farmářských trzích.',
        img:'https://images.unsplash.com/photo-1576673442511-7e39b6545c87?w=400&q=80&fit=crop&auto=format' },
      ...
      { name:'Svíčková zelenina', emoji:'🥦', best:'Říjen–Únor', tip:'Čerstvá zelenina na svíčkovou nebo dušení – mrkev, celer, petržel od farmáře.',
        img:'https://images.unsplash.com/photo-1598170845058-32b9d6a5da37?w=400&q=80&fit=crop&auto=format' },
    ],
  },
};
